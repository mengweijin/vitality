...
public class ProcessUtils {
    ...
    public void readCache(Process process) throws InterruptedException {
        // 读取子进程的输入流
    ...
    static class ProcessInputDaemonThread extends Thread {
        ...
        public void run() {
            try (
                    InputStreamReader inReader = new InputStreamReader(inputStream, Const.UTF_8);
                ...
                log.info("Process message:" + sb.toString());
            } catch (IOException e) {
