...
INSERT INTO QB_USER VALUES (15, 'test',   '{bcrypt}$2a$10$rexTyLgtv2KcoKoZKP7oBeeReIGbqmGzVQBypbnLvt3/ulTOJDoTG', '展示用户',  0,  CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'SYSTEM', 'SYSTEM');
...
insert into QB_ROLE_AUTH values (1, 15, 101, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'SYSTEM', 'SYSTEM');
insert into QB_ROLE_AUTH values (2, 15, 102, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'SYSTEM', 'SYSTEM');
insert into QB_ROLE_AUTH values (3, 15, 103, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'SYSTEM', 'SYSTEM');
insert into QB_ROLE_AUTH values (4, 15, 201, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'SYSTEM', 'SYSTEM');
insert into QB_ROLE_AUTH values (5, 15, 202, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'SYSTEM', 'SYSTEM');
insert into QB_ROLE_AUTH values (6, 15, 203, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'SYSTEM', 'SYSTEM');
