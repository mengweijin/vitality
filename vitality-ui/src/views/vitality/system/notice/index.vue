...
import Release from "@iconify-icons/ep/promotion";
import Withdraw from "@iconify-icons/ep/refresh-left";
...
<template>
  <div class="main">
    ...
    >
      ...
      <el-form-item label="状态：" prop="released">
        <el-select
        ...
        >
          <el-option
            v-for="(item, index) in useDictStoreHook().getDicts('vtl_released')"
            :key="index"
            :label="item.label"
            :value="item.val"
          />
        ...
        >
          <template #operation="{ row }">
            <el-button
              ...
              @click="openDetailDialog('通知/公告', row)"
            >
              详情
            </el-button>
            <el-button
