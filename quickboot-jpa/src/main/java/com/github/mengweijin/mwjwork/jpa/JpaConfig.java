...
import com.github.mengweijin.mwjwork.jpa.repository.SimpleBaseJpaRepository;
...
@Configuration
@EnableJpaAuditing
@EnableJpaRepositories(repositoryBaseClass = SimpleBaseJpaRepository.class, basePackages = {"com.github.mengweijin"})
