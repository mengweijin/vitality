layui.define(['jquery', 'layer'], function (exports) {
    ...
    vitality.ajaxSetupInited = false;
            ...
            */
            $.ajaxSetup({
                ...
                beforeSend: function (xhr) {
                    ...
                    if(!(this.url.indexOf('http') == 0) && !vitality.util.isBlank(ajaxBaseUrl)) {
    ...
    vitality.init = function() {
        vitality.ajax.addMethod();
        if(!vitality.ajaxSetupInited){
            vitality.ajax.setAjaxSetup();
        }
    }

    vitality.init();

    exports('vitality', vitality);
});