...
import { useLogAlert } from "./utils/hook";
...
<template>
  <div class="main">
    ...
    <PureTableBar title="错误日志" :columns="columns" @refresh="onSearch">
      ...
      <template v-slot="{ size, dynamicColumns }">
        ...
        >
          <template #operation="{ row }">
            ...
            <el-popconfirm
              :width="500"
              :title="`是否确认【删除】异常名称为【${row.exceptionName}】的数据？`"
