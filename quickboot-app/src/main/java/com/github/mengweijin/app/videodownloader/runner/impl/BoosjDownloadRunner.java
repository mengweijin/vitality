...
import com.github.mengweijin.app.videodownloader.util.FfmpegUtils;
import com.github.mengweijin.app.videodownloader.util.M3U8Utils;
import com.github.mengweijin.quickboot.framework.constant.Const;
import com.github.mengweijin.quickboot.framework.exception.ServerException;
import com.github.mengweijin.quickboot.framework.util.http.JsoupUtils;
...
public class BoosjDownloadRunner extends BaseDownloadRunner {
    ...
    public File execute() {
        ...
        String videoName = com.github.mengweijin.quickboot.framework.util.FileUtil.replaceSpecialCharactersInFileName(videoInfo.getVideoName());
